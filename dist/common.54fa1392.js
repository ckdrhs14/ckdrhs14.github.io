...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"page/myWeb/random_thumb/js/common.js":[function(require,module,exports) {
// 햄버거 메뉴  
...
function pageClick() {
  document.querySelectorAll(".page_click").forEach(function (elem) {
    elem.addEventListener("click", function (e) {
      ...
      setTimeout(function () {
        window.location.href = "http://leeboa.com/" + dataName + ".html";
      }, 2000);
    });
  });
}
...
$(window).scroll(function () {
  ...
  if (scroll > sec2_top) {
    gsap.to(".overview span", {
      duration: 0.9,
      opacity: 1,
      x: 3
    });
    gsap.to(".about-text p:nth-child(1)", {
      duration: 0.7,
      stagger: 0.015,
      opacity: 1,
      y: 3,
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","page/myWeb/random_thumb/js/common.js"], null)
//# sourceMappingURL=/common.54fa1392.js.map